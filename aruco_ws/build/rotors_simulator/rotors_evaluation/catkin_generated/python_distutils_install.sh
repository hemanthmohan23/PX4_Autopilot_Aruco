...
echo_and_run cd "/home/hemanth/aruco_ws/src/rotors_simulator/rotors_evaluation"
...
echo_and_run /usr/bin/env \
    ...
    "/home/hemanth/aruco_ws/src/rotors_simulator/rotors_evaluation/setup.py" \
     \
    build --build-base "/home/hemanth/aruco_ws/build/rotors_simulator/rotors_evaluation" \
    install \
    --root="${DESTDIR-/}" \
